...
const selectLexer = require("../step1_lexing/lexer")
// re-using the parser implemented in step two.
const parser = require("../step2_parsing/parser")
...
const BaseJsonVisitor = parserInstance.getBaseCstVisitorConstructor()

class JsonToAstVisitor extends BaseJsonVisitor {
    constructor() {
        super()
