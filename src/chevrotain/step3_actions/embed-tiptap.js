...
class JsonParserEmbed extends Parser {
  constructor() {
    ...
    $.RULE('template', () => {
      ...
      return { type: tempName, attrs: obj, content: content };
    });
...
// const templateMap = require('./templates-map').templateMap;

module.exports = {
  toTipTapAst: function(inputText) {
