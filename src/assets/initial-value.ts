...
# Titre du document 2 ([théorème](#bx-bonjour-le-theoreme))

## Sous-titre

Ensuite pas de titre enfin si quand $bonjour$ même $\\forall y \\in \\R$. Et du code un peu \`inline\` puis c'est tout pour l'instant :smile:.

-----

- un block texte encore ici;
- un block texte encore ici.
- <trko-annotation annotated="Hello dans une annotation plus longue">A l'intérieur de l'annotation.<trko-box heading="Bonjour">Bonjour on est ivi ok ok.</trko-box></trko-annotation> dans la même liste;
- un block texte encore ici;
- un block texte encore ici.
