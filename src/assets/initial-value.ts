...
- un block texte encore ici.
- <trko-annotation an="Hello dans une annotation plus longue">A l'intérieur de l'annotation.<trko-box heading="Bonjour">Bonjour on est ivi ok ok.</trko-box></trko-annotation> dans la même liste;
- un block texte encore ici;
- un block texte encore ici.
